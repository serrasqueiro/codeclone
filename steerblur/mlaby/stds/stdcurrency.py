...
dict_ISO4217={
    ...
    ("ANTARCTICA",	"No universal currency", "", "0", ""),
    ...
    ("CURACAO",	"Netherlands Antillean Guilder", "ANG", "532", "2"),
    ...
    ("PALESTINE, STATE OF",	"No universal currency", "", "0", ""),
    ...
    ("SISTEMA UNITARIO DE COMPENSACION REGIONAL DE PAGOS",	"Sucre", "XSU", "994", "N.A."),
    ...
    ("SOUTH GEORGIA AND THE SOUTH SANDWICH ISLANDS",	"No universal currency", "", "0", ""),
    ...
    ("VENEZUELA (BOLIVARIAN REPUBLIC OF)",	"Bolivar Soberano", "VES", "928", "2"),
...
dict_ISO4217_fundList=(984, 990, 970, 979, 947, 948, 997, 940)
